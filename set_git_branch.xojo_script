...
// Auslesen der aktuell verwendeten Git-Branch, und abspeichern als Textdatei im Projekt Pfad als Datei <git_branch.txt>
// Sollte git auf dem System nicht installiert sein, bleibt die Textdatei leer
