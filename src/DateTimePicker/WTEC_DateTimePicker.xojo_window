...
#tag WindowCode
	...
	#tag Method, Flags = &h21, Description = 4469657365204D6574686F64652065727A657567742065696E656E206E6575656E204B616C656E6465722C2064657220417566727566206572666F6C67742064757263682054696D6572
		Private Sub CreateCalendar()
		  ...
		  CalendarContainer =  WTEC_Calendar.CreateCalendar(Me.TF_DateInput, para)
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0, Description = 
		Shared Function dtToString(d as DateTime, loc as Locale, withTime as boolean = false, withSeconds as boolean = false) As string
		  // Rückgabe des übergebenen Datums d als String
		  ...
		  If d <> Nil Then
		    ...
		    If withTime Then
		      // Ausgabe mit Uhrzeit
		      If withSeconds Then
		        Return d.ToString( loc, DateTime.FormatStyles.Medium, DateTime.FormatStyles.Medium)
		      Else
		        Return d.ToString( loc, DateTime.FormatStyles.Medium, DateTime.FormatStyles.Short)
		      End If
		    Else
		      // Ausgabe ohne Uhrzeit
		      Return d.ToString( loc, DateTime.FormatStyles.Medium, DateTime.FormatStyles.None)
		    End If
		  End If
	...
	#tag Method, Flags = &h0, Description = 5365747A742064617320616B7475656C6C65204B616C656E646572646174756D
		Sub SetDate(year as integer, month as integer, day as integer)
		  ...
		  If CalendarContainer <> Nil Then
		    ...
		    If CalendarContainer.Value <> Nil Then _
		    WTEC_Calendar(CalendarContainer.Value).SetDate(year, month, day)
		  Else
		    // Callback
	...
	#tag Method, Flags = &h0, Description = 45696E2062657374696D6D74657320446174756D20756E6420646965205568727A65697420696D204B616C656E646572207365747A656E
		Sub SetDateTime(d as Datetime)
		  ...
		  If CalendarContainer <> Nil Then
		    // Callback wird durch Kalender ausgelöst
		    If CalendarContainer.Value <> Nil Then _
		    WTEC_Calendar(CalendarContainer.Value).SetDateTime(d)
		  Else
		    // Callbacks
		    RaiseEvent DateChanged(d.Year, d.Month, d.day)
	...
	#tag Method, Flags = &h0, Description = 5365747A742064696520616B7475656C6C65205A656974
		Sub SetTime(hour as integer, minute as integer, second as integer)
		  ...
		  If CalendarContainer <> Nil Then
		    // Callback wird durch Kalender ausgelöst
		    If CalendarContainer.Value <> Nil Then _
		    WTEC_Calendar(CalendarContainer.Value).SetTime(hour,minute,second)
		  Else
		    // Callback
	...
	#tag Property, Flags = &h21, Description = 5265666572656E7A207A756D206765C3B666666E6574656E204B616C656E64657220436F6E7461696E65722C204E494C2077656E6E206E6963687420696E6974616C697369657274
		Private CalendarContainer As WeakRef
	#tag EndProperty
			...
			Set
			  ...
			  If value <> zIsExpanded Then
			    ...
			    If value Then
			      ...
			      #If TargetWindows
			        // Wenn Windows mal wieder länger braucht.....Zeit geben um einen bestehenden Kalender zu zerstören
			        Timer.CallLater(200, WeakAddressOf CreateCalendar)
			      #Else
			        // Linux ist schon fertig
			        CreateCalendar
			      #EndIf
		...
		Sub TextChanged()
		  ...
		  If AcceptInput Then
		    ...
		    Catch InvalidArgumentException
		      ...
		      Me.TextColor = WTEC_Color.TextError
		      Return
		    ...
		    If Self.CalendarContainer.Value <> Nil Then _
		    WTEC_Calendar(CalendarContainer.Value).SetDate(d.Year,d.Month,d.Day)   // Nur wenn expandiert
	...
	#tag Event , Description = 446965205A65697420646965736573205465787466656C64207775726465206765C3A46E64657274
		Sub TimeChanged(value as integer)
		  If actualHour <> value Then
		    ...
		    If CalendarContainer.Value <> Nil Then _
		    WTEC_Calendar(CalendarContainer.Value).SetTime(actualHour, actualMinute, actualSecond, True)
